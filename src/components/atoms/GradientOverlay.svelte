...
<div
	class={clsx(
		...
		match(roundedPosition)
			...
			.with('tl', () => 'rounded-tl-[2rem] rounded-tl-[4rem]')
			.with('tr', () => 'rounded-tr-[2rem] rounded-tr-[4rem]')
			.with('bl', () => 'rounded-bl-[2rem] rounded-bl-[4rem]')
			.with('br', () => 'rounded-br-[2rem] rounded-br-[4rem]')
			.with('none', () => '')
			.exhaustive(),
		className
	)}
